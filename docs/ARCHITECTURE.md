...
- `game/` — the Unity project (scaffolded 2026-07-18 from DESIGN_BRIEF.md).
  - `game/Assets/Scripts/` — 35 C# files, everything built code-first from a near-empty Boot scene (no hand-authored prefabs). Includes the multiplayer front-end + networking seam (D-017), the onboarding front end (D-022), and the distance/spacing layer (D-023).
