...
Scope: this list covers the **vertical slice** (Vision Goal 1: full touch combat between Kest and Tengi, one living harbor stage with a Khulandra event, one Horrific Ending each, one motion-comic sequence) plus core UI and audio. It grows with the design brief. **Animation pipeline: decided (D-011) and listed.** Character animation ships as per-move rigged clip GLBs generated on Kest's rig and retargeted to both champions via the shared Meshy humanoid skeleton (ARCHITECTURE.md §Animation pipeline). The clip library is now **24 Kest clips**: idle, walk, punch, block, hit, death (session 3) + special, airrake, airslam, parry, backdash (session 8 — the deferred combat-art library from D-015) + clawjab, clawcross, clawhook, clawupper, clawslam, haymaker, tailround, tailsweep, legsweep, haunchbash, grab, throw, crouchguard (session 10 — the kaiju-scaled moveset and its guard stance, D-024). Wired into the runtime `FighterAnimator`: everything except **airrake/airslam/parry/backdash**, which stay generated + synced and one-line-wireable pending an on-device look (see RoundManager.ClipFiles + STATUS).
...
| char_kest_anim_clawjab | assets/characters/kest_anim_clawjab.glb | animated GLB — derived from char_kest_apose (clip: Right_Jab_from_Guard #192) | placeholder | — |
| char_kest_anim_clawhook | assets/characters/kest_anim_clawhook.glb | animated GLB — derived from char_kest_apose (clip: Left_Hook_from_Guard #193) | placeholder | — |
| char_kest_anim_clawupper | assets/characters/kest_anim_clawupper.glb | animated GLB — derived from char_kest_apose (clip: Charged_Upward_Slash #221) | placeholder | — |
| char_kest_anim_clawcross | assets/characters/kest_anim_clawcross.glb | animated GLB — derived from char_kest_apose (clip: Thrust_Slash #240) | placeholder | — |
| char_kest_anim_clawslam | assets/characters/kest_anim_clawslam.glb | animated GLB — derived from char_kest_apose (clip: Heavy_Hammer_Swing #128) | placeholder | — |
| char_kest_anim_haymaker | assets/characters/kest_anim_haymaker.glb | animated GLB — derived from char_kest_apose (clip: Punch_Forward_with_Both_Fists #214) | placeholder | — |
| char_kest_anim_tailround | assets/characters/kest_anim_tailround.glb | animated GLB — derived from char_kest_apose (clip: Roundhouse_Kick #207) | placeholder | — |
| char_kest_anim_tailsweep | assets/characters/kest_anim_tailsweep.glb | animated GLB — derived from char_kest_apose (clip: Sweeping_Kick #217) | placeholder | — |
| char_kest_anim_legsweep | assets/characters/kest_anim_legsweep.glb | animated GLB — derived from char_kest_apose (clip: Leg_Sweep #213) | placeholder | — |
| char_kest_anim_haunchbash | assets/characters/kest_anim_haunchbash.glb | animated GLB — derived from char_kest_apose (clip: Boxing_Guard_Step_Knee_Strike #211) | placeholder | — |
| char_kest_anim_grab | assets/characters/kest_anim_grab.glb | animated GLB — derived from char_kest_apose (clip: Step_Forward_and_Push #259) | placeholder | — |
| char_kest_anim_throw | assets/characters/kest_anim_throw.glb | animated GLB — derived from char_kest_apose (clip: Charged_Ground_Slam #127) | placeholder | — |
| char_kest_anim_crouchguard | assets/characters/kest_anim_crouchguard.glb | animated GLB — derived from char_kest_apose (clip: Block10 #146) | placeholder | — |
...
### char_kest_anim_{clawjab,clawhook,clawupper,clawcross,clawslam,haymaker,tailround,tailsweep,legsweep,haunchbash,grab,throw,crouchguard} — 2026-07-25 (session 10, kaiju-scaled moveset + guard, D-024)
- Model: image_to_3d (Meshy) — should_texture + enable_rigging + enable_animation, pose_mode a-pose, rigging_height_meters 1.8, rig action library per D-011
- Job IDs: clawjab eeaad8c9-95f2-4a70-870e-8035184a24f7 (action 192 Right_Jab_from_Guard), clawhook 0e03d451-56a3-4272-bb4f-9085b739e507 (193 Left_Hook_from_Guard), clawupper 5d844e08-497b-4dd2-8c79-14b3feab2ddf (221 Charged_Upward_Slash), clawcross 0e7b3333-2ece-44bf-9970-de4649b37191 (240 Thrust_Slash), clawslam 21e29818-081b-46ed-9851-8c766d8df40b (128 Heavy_Hammer_Swing), haymaker e137bc15-d829-41a7-ad38-0b8a8c145bec (214 Punch_Forward_with_Both_Fists), tailround c83dd723-4f57-4e43-ab46-3d4e4ac9504d (207 Roundhouse_Kick), tailsweep 0db7c74a-859b-4a6e-8ace-bf586d3dd35b (217 Sweeping_Kick), legsweep 1e7a273c-8b78-4b1d-9674-2569936bac51 (213 Leg_Sweep), haunchbash 491611fa-603d-4050-9a23-03e61c93a48f (211 Boxing_Guard_Step_Knee_Strike), grab ba7c546b-c6e6-4b1d-95d9-4fb3ce266621 (259 Step_Forward_and_Push), throw 1976671f-de25-422b-998f-b89753847a80 (127 Charged_Ground_Slam), crouchguard f98b654f-e63c-442b-8fa4-7a178c9b5afc (146 Block10)
- Seed: 20260718 (all — the session-3 seed, so all 24 clips share one skeleton and retarget onto both champions)
- Prompt: none (all derived from char_kest_apose, job 37123379-042e-4bc0-950b-305caef34a85, fed by job_id as the image reference)
- Notes: One clip per move for the D-024 moveset (owner's scope: claw jab / hook / rising uppercut / cross / overhead slam / haymaker, tail roundhouse / low leg sweep / haunch bash, command grab + body-slam throw) plus the **crouch-guard** stance the mix-up needs. **Actions were chosen by watching them, not by name:** every candidate's `animation_actions` preview GIF was pulled and montaged into contact sheets before picking, which is how the crouch guard was found (**Block10** is the only Block variant that sinks into a low braced stance and *holds* it — the rest are standing arm-blocks) and how the overhead/haymaker pair was assigned (Heavy_Hammer_Swing raises both arms overhead and drives down = the overhead slam; Punch_Forward_with_Both_Fists winds wide and smashes forward = the haymaker; Charged_Ground_Slam hauls up and slams into the ground = the throw). Weapon-named actions (Thrust_Slash, Charged_Upward_Slash) were verified prop-free in the preview and read as a straight claw thrust and a rising whole-body slash — chosen deliberately over the boxing-form variants because Pillar 2 wants kaiju mass, not human boxing. **13 × 38 = 494 cr**; no failed attempts. All 13 delivered valid glTF-binary v2, 10.4–10.8 MB, and were verified against the existing library by parsing their glTF JSON: **26 nodes / 24 joints / 72 channels each — identical to `kest_anim_punch.glb`** (the replacement contract's "a replacement mesh must keep the placeholder's skeleton" rule, checked rather than assumed), each carrying exactly its intended action, 0.60–4.77 s long. **All 13 are wired** in `RoundManager.ClipFiles` (unlike the session-8 four, which stay the owner's on-device call): a moveset whose whole purpose is a readable low/overhead/grab mix-up is not readable on a shared punch clip. Because the clips run 0.6–4.8 s while a normal recovers in 0.20–0.70 s, `FighterAnimator.PlayFor` now fits each clip to its move's window (clamped 1–6×) — at speed 1 a jab showed only the first ~10% of its clip and the fighter was still winding up after the hit resolved. Several clips carry root translation (roundhouse, both sweeps, the grab step): that shows as the model sliding inside its own silhouette, never as sim movement (the sim's X is untouched by animation), and each is droppable by commenting one `ClipFiles` line. Derived-asset rule applies to all 13 (flip to needs-rework if char_kest_apose changes). Placeholder/inference by contract like every character asset.
